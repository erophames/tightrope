...
export function RoutingOptionsSection({
  ...
  return (
    <div className="settings-group">
      ...
      <div className="setting-row">
        <div className="setting-label">
          <strong>Strict lock pool continuations</strong>
          <span>Force continuation requests to stay inside a locked routing pool</span>
        </div>
        <button
          className={`setting-toggle${strictLockPoolContinuations ? ' on' : ''}`}
          type="button"
          aria-label="Toggle strict lock pool continuations"
