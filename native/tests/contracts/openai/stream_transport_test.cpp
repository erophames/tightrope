...
TEST_CASE("native codex header detection mirrors reference-upstream behavior", "[proxy][provider]") {
...
TEST_CASE("stream transport resolver matches reference-upstream selection order", "[proxy][provider]") {
